...
require_once(ROOT_PATH . '/admin/xfiles/admin_functions.php');


?>

<?php $infos = getAllInfos(); ?>
...
<!--main body-->
    ...
    <div class="main">
        <div class="container-fluid"> <!--rows wrapper-->
            ...
            <div class="row">
                <div class="col">
                    <div class="v-info-link">
                        <h5><a href="verified_infos.php">View all verified Infos --></a></h5>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class=" col-md-4" >
                                <div class="line">
                                    ...
                                    <p><?php echo $info['dob'] ?></p><hr>
                                    <p><?php echo $info['bio'] ?></p><hr>
                                    <?php $student_id = $info['student_id']?>
                                </div>
                            </div>
                            <div class=" col-md-6 " >
                               <div class="img-div">
                                    <img src="<?php echo "../static/uploads/img/" . $info['image']; ?>" alt="profile picture" height="300" width="100%">
                               </div>
                            </div>
                            <div class=" col-md-1 line">
                                    ...
                                    <h5>Verified</h5><hr>
                                        <div class="center">
                                            <p class="centered1"><?php echo  ($info['verified'] == 1 ) ? "YES"  : "NO"  ;  ?></p>
                                        </div>
                                
                            </div>
                            <div class=" col-md-1 line">
                                <div class="center">
                                    <p class="centered"><a id="delete" href="dashboard.php?id=<?php echo $student_id ?>">Delete</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
